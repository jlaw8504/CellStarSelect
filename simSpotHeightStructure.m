function s = simSpotHeightStructure(directory, field1nopattern, field2nopattern, field3nopattern, spbChannel, outerChannel, spindleBounds, zTilt, skewThresh, pixelSize, regionSize)
...
[s.allDataCell,s.KickedOut] = aggSimImagesModified(s.name_struct);
